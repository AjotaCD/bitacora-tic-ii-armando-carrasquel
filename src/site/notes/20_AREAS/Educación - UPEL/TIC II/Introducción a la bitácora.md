---
{"dg-publish":true,"permalink":"/20_AREAS/Educación - UPEL/TIC II/Introducción a la bitácora/","tags":["gardenEntry"],"noteIcon":"[material-symbols--note-alt.svg](/img/user/99_ADJUNTOS/material-symbols--note-alt.svg)","dg-note-properties":{"editor-width":100,"cssclasses":["hide-properties"],"sticker":"lucide//home","banner_y":"46","banner":"https://i.pinimg.com/736x/8d/2b/cc/8d2bccbf38151cfa6c727eabcc9531ec.jpg"}}
---

**Asignatura**: Tecnologías de la Información y Comunicación II (TIC II)
Educación Mención Lengua y Literatura
**Autor**: Armando Carrasquel
Tutor: Mg. Edgardo Yrausquin
**Actividades a realizar:** Registro cronológico de avances, proyectos y reflexiones del semestre.
# Índice Estructural de Actividades
...
Como estudiante con **hiperlaxitud articular**, la eficiencia en la interacción con el software es fundamental para evitar la fatiga física. El flujo de trabajo del Digital Garden optimiza mi rendimiento al:

- **Reducir clics y fricción:** Escribo en Markdown localmente y publico con un solo comando.
    
- **Organización Orgánica:** Permite una reflexión crítica profunda sin las distracciones de interfaces web pesadas.
    
- **Cumplimiento de Criterios:** Esta transición es, en sí misma, una evidencia de **Uso de la Herramienta (4%)** y **Creatividad (4%)**, al proponer una solución tecnológica superior para cumplir con los objetivos académicos.
    

### Arquitectura del Jardín

He diseñado este espacio bajo un modelo de **Nodo Central**, asegurando que el profesor Mg. Edgardo Yrausquin mantenga la claridad en la navegación:

1. **Portada e Índice Innegociables:** El punto de entrada siempre será la identificación formal y el acceso estructurado a las actividades.
...
De acuerdo a las pautas del profesor, este espacio servirá para documentar:

- **Avances y Obstáculos:** Registro de lo que voy logrando y los retos técnicos enfrentados.
...
>Gracias a la función "Canvas" de obsidian, en esta misma plataforma estaré administrando un tablero digital alternativo
